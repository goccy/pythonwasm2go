...
func callIndirect_type9(m *base.Module, idx int32, p0 int32, p1 int32, p2 int32, p3 int32, p4 int32, p5 int32) int32 {
	return m.T0[idx].(func(*base.Module, int32, int32, int32, int32, int32, int32) int32)(m, p0, p1, p2, p3, p4, p5)
}
...
func callIndirect_type12(m *base.Module, idx int32, p0 int32, p1 int32, p2 int32, p3 int32, p4 int32, p5 int32, p6 int32) int32 {
	return m.T0[idx].(func(*base.Module, int32, int32, int32, int32, int32, int32, int32) int32)(m, p0, p1, p2, p3, p4, p5, p6)
}

func callIndirect_type13(m *base.Module, idx int32) {
	m.T0[idx].(func(*base.Module))(m)
}
...
func callIndirect_type15(m *base.Module, idx int32, p0 float64) float64 {
	return m.T0[idx].(func(*base.Module, float64) float64)(m, p0)
}

func callIndirect_type19(m *base.Module, idx int32, p0 int32, p1 int64) int32 {
	return m.T0[idx].(func(*base.Module, int32, int64) int32)(m, p0, p1)
}

func callIndirect_type21(m *base.Module, idx int32, p0 int32, p1 int32, p2 int32, p3 int32, p4 int32, p5 int32, p6 int32, p7 int32, p8 int32, p9 int32) int32 {
	return m.T0[idx].(func(*base.Module, int32, int32, int32, int32, int32, int32, int32, int32, int32, int32) int32)(m, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9)
}
...
func callIndirect_type24(m *base.Module, idx int32, p0 float64, p1 float64) float64 {
	return m.T0[idx].(func(*base.Module, float64, float64) float64)(m, p0, p1)
}

func callIndirect_type31(m *base.Module, idx int32, p0 int64, p1 int32) int32 {
	return m.T0[idx].(func(*base.Module, int64, int32) int32)(m, p0, p1)
}

func callIndirect_type41(m *base.Module, idx int32, p0 int32, p1 int64, p2 int32) {
	m.T0[idx].(func(*base.Module, int32, int64, int32))(m, p0, p1, p2)
}

func callIndirect_type45(m *base.Module, idx int32, p0 int32, p1 float32) int32 {
	return m.T0[idx].(func(*base.Module, int32, float32) int32)(m, p0, p1)
}
